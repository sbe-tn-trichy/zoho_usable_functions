...
NEOSEAL_GROUP_RULES: tuple[tuple[str, str], ...] = (
    ...
    (r"\bCPVC Solution\b", "CPVC Solvent"),
    ...
    (r"\bSeal X\b", "Seal X"),
    (r"\bGP Silicon Sealant\b", "GP Silicon Sealant"),
    (r"\bGasket Shellac\b", "Gasket Shellac"),
    (r"\bNeoflex\b", "Neoflex"),
    (r"\bDrain Cleaner\b", "Drain Cleaner"),
